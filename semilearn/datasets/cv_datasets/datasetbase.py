        ...
        if self.transform is None:
            ...
            if not self.is_ulb:
                ...
                if self.alg == 'fullysupervised' or self.alg == 'supervised':
                    ...
                    return {'idx_ulb': idx, 'x_ulb_w': img_w, 'x_ulb_s_0': self.strong_transform(img), 'x_ulb_s_1':self.strong_transform1(img)} 
                elif self.alg in ['pivotmatch', 'pivotmatch1', 'pivotmatch2', 'pivotmatch3', 'dinomatch1', 'dinomatch2']:
                    # return {'idx_ulb': idx, 'x_ulb_w': img_w, 'x_ulb_s_0': self.strong_transform(img), 'x_ulb_s_1':self.strong_transform(img)} 
                    return {'idx_ulb': idx, 'x_ulb_w': img_w, 'x_ulb_s_0': self.strong_transform(img), 'x_ulb_s_1':self.strong_transform1(img), 'y_ulb': target} 
                else:
