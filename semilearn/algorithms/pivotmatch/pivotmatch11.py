...
# pivotmatch 3 rebuild, no ema, no strong queue, no self
# pivotmatch orig, no pivots, only confident set
...
@ALGORITHMS.register('pivotmatch11')
class PivotMatch11(AlgorithmBase):
    """
