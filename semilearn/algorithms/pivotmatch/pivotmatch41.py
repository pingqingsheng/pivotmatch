...
# strong + soft for pivot, pivot + queue contrast representation, pivot propagation
#  
...
@ALGORITHMS.register('pivotmatch41')
class PivotMatch41(AlgorithmBase):
    ...
    def train_step(self, x_lb, y_lb, x_ulb_w, x_ulb_s, y_ulb):
        ...
        with self.amp_cm():
            ...
            if self.epoch >= self.epoch_warm_up:
                ## pivot loss
                loss_p = self.loss_p(affinity_u_s[idx_conf] / self.temperature, pivot_code)
